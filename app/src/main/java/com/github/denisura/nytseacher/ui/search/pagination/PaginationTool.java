...
import com.github.denisura.nytseacher.utils.BackgroundExecutor;
...
public class PaginationTool<T> {
    ...
    public Observable<T> getPagingObservable() {
        ...
        return getScrollObservable(recyclerView, limit, emptyListCount)
                ...
                .switchMap(options -> getPagingObservable(pagingListener, pagingListener.onNextPage(options), startNumberOfRetryAttempt, options, retryCount));
    }
